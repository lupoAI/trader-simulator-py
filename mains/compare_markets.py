...
if not os.path.exists("../results/compare_markets/"):
    os.mkdir("../results/compare_markets/")
...
real_market_visualizer.compare_market(1, simulated_market_visualizer,
                                      '../results/compare_markets/comparison_real_fake_1_rets.jpg')
real_market_visualizer.compare_market(5, simulated_market_visualizer,
                                      '../results/compare_markets/comparison_real_fake_5_rets.jpg')
real_market_visualizer.compare_market(15, simulated_market_visualizer,
                                      '../results/compare_markets/comparison_real_fake_15_rets.jpg')
real_market_visualizer.compare_market(30, simulated_market_visualizer,
                                      '../results/compare_markets/comparison_real_fake_30_rets.jpg')
