...
ax1 = plt.subplot2grid(shape=(2, 6), loc=(0, 0), colspan=2, rowspan=2)
ax2 = plt.subplot2grid((2, 6), (0, 2), colspan=2, rowspan=2)
ax3 = plt.subplot2grid((2, 6), (0, 4), colspan=2, rowspan=2)

ax1.plot(n_agents_list, n_agents_time_random, label='random time')
ax1.plot(n_agents_list, n_agents_time_fcn, label='fcn time')
ax1.set_xlabel('n_agents')
ax1.set_ylabel('time')
ax1.set_title('Number of Agent vs Time')
ax1.legend()

ax2.plot(n_steps_list, n_steps_time_random, label='random time')
ax2.plot(n_steps_list, n_steps_time_fcn, label='fcn time')
ax2.set_xlabel('n_steps')
ax2.set_ylabel('time')
ax2.set_title('Number of Steps vs Time')
ax2.legend()

ax3.plot(trades_per_step_list, trades_per_step_time_random, label='random time')
ax3.plot(trades_per_step_list, trades_per_step_time_fcn, label='fcn time')
ax3.set_xlabel('trades_per_step')
ax3.set_ylabel('time')
ax3.set_title('Trades per Step vs Time')
ax3.legend()
